...
function _end(deviceId, callback) {
...
function _init(version, worklet) {
 ...
 function getStringFromPtr(ptr) {
  if (document.FGUnityMicrophone.unityVersion >= 2021) {
...
function _setRecordingBufferCallback(callback) {
...
function _start(deviceId, frequency, callback) {
...
var asmLibraryArg = {
 ...
 "Unity_BrowserCallFactory_InjectJsCode": _Unity_BrowserCallFactory_InjectJsCode,
 "Unity_DeviceApi_LastUpdate": _Unity_DeviceApi_LastUpdate,
 "Unity_DeviceApi_RequestUpdate": _Unity_DeviceApi_RequestUpdate,
 "Unity_DeviceApi_Update": _Unity_DeviceApi_Update,
 "Unity_InitAsync": _Unity_InitAsync,
 "Unity_MediaNetwork_Configure": _Unity_MediaNetwork_Configure,
 "Unity_MediaNetwork_Create": _Unity_MediaNetwork_Create,
 "Unity_MediaNetwork_GetConfigurationError": _Unity_MediaNetwork_GetConfigurationError,
 "Unity_MediaNetwork_GetConfigurationState": _Unity_MediaNetwork_GetConfigurationState,
 "Unity_MediaNetwork_HasAudioTrack": _Unity_MediaNetwork_HasAudioTrack,
 "Unity_MediaNetwork_HasUserMedia": _Unity_MediaNetwork_HasUserMedia,
 "Unity_MediaNetwork_HasVideoTrack": _Unity_MediaNetwork_HasVideoTrack,
 "Unity_MediaNetwork_IsAvailable": _Unity_MediaNetwork_IsAvailable,
 "Unity_MediaNetwork_IsMute": _Unity_MediaNetwork_IsMute,
 "Unity_MediaNetwork_ResetConfiguration": _Unity_MediaNetwork_ResetConfiguration,
 "Unity_MediaNetwork_SetMute": _Unity_MediaNetwork_SetMute,
 "Unity_MediaNetwork_SetVolume": _Unity_MediaNetwork_SetVolume,
 "Unity_MediaNetwork_TryGetFrame": _Unity_MediaNetwork_TryGetFrame,
 "Unity_MediaNetwork_TryGetFrameDataLength": _Unity_MediaNetwork_TryGetFrameDataLength,
 "Unity_MediaNetwork_TryGetFrame_Resolution": _Unity_MediaNetwork_TryGetFrame_Resolution,
 "Unity_MediaNetwork_TryGetFrame_ToTexture": _Unity_MediaNetwork_TryGetFrame_ToTexture,
 "Unity_Media_GetVideoDevices": _Unity_Media_GetVideoDevices,
 "Unity_Media_GetVideoDevices_Length": _Unity_Media_GetVideoDevices_Length,
 "Unity_PollInitState": _Unity_PollInitState,
 "Unity_SLog_SetLogLevel": _Unity_SLog_SetLogLevel,
 "Unity_VideoInput_AddCanvasDevice": _Unity_VideoInput_AddCanvasDevice,
 "Unity_VideoInput_AddDevice": _Unity_VideoInput_AddDevice,
 "Unity_VideoInput_RemoveDevice": _Unity_VideoInput_RemoveDevice,
 "Unity_VideoInput_UpdateFrame": _Unity_VideoInput_UpdateFrame,
 "Unity_WebRtcNetwork_Connect": _Unity_WebRtcNetwork_Connect,
 "Unity_WebRtcNetwork_Create": _Unity_WebRtcNetwork_Create,
 "Unity_WebRtcNetwork_Dequeue": _Unity_WebRtcNetwork_Dequeue,
 "Unity_WebRtcNetwork_Disconnect": _Unity_WebRtcNetwork_Disconnect,
 "Unity_WebRtcNetwork_Flush": _Unity_WebRtcNetwork_Flush,
 "Unity_WebRtcNetwork_GetBufferedAmount": _Unity_WebRtcNetwork_GetBufferedAmount,
 "Unity_WebRtcNetwork_IsAvailable": _Unity_WebRtcNetwork_IsAvailable,
 "Unity_WebRtcNetwork_IsBrowserSupported": _Unity_WebRtcNetwork_IsBrowserSupported,
 "Unity_WebRtcNetwork_Peek": _Unity_WebRtcNetwork_Peek,
 "Unity_WebRtcNetwork_PeekEventDataLength": _Unity_WebRtcNetwork_PeekEventDataLength,
 "Unity_WebRtcNetwork_Release": _Unity_WebRtcNetwork_Release,
 "Unity_WebRtcNetwork_SendData": _Unity_WebRtcNetwork_SendData,
 "Unity_WebRtcNetwork_Shutdown": _Unity_WebRtcNetwork_Shutdown,
 "Unity_WebRtcNetwork_StartServer": _Unity_WebRtcNetwork_StartServer,
 "Unity_WebRtcNetwork_StopServer": _Unity_WebRtcNetwork_StopServer,
 "Unity_WebRtcNetwork_Update": _Unity_WebRtcNetwork_Update,
 ...
 "getRecordingBuffer": _getRecordingBuffer,
 ...
 "setRecordingBufferCallback": _setRecordingBufferCallback,
...
var dynCall_viijiiiijjjjji = Module["dynCall_viijiiiijjjjji"] = createExportWrapper("dynCall_viijiiiijjjjji");
...
if (!Object.getOwnPropertyDescriptor(Module, "CallbacksMap")) Module["CallbacksMap"] = function() {
 abort("'CallbacksMap' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
};
